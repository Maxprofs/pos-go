...
public class OpenGlTriangle {
    ...
    OpenGlTriangle(Context context) throws IOException {
        ...
        vertexShader = FileUtils.loadStringFromAsset(context, "shaders/gles2.ep01.vertshader");
        fragmentShader = FileUtils.loadStringFromAsset(context, "shaders/gles2.ep01.fragshader");
    }
